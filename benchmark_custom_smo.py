...
from custom_smo import SVM

def benchmark_svm(num_samples=4000, num_features=20, test_size=0.2, random_state=42):
    ...
    model = SVM(c=1.0,kkt_thr=1e-10, max_iter=10000, kernel_type='rbf', gamma_rbf=gamma)
